...
export default function Edit() {
        ...
        axios.post('https://xtralife-server.onrender.com/edit', values)
        .then(res => {
    ...
    return (
        <div>
            ...
            {/* Renderiza un formulario donde recogeremos los datos con los que actualizar uno de los usuarios de nuestra base de datos */}
            <div className="form">
                <h1>Actualiza tus datos, recuerda rellenar la pagina completa.</h1>
